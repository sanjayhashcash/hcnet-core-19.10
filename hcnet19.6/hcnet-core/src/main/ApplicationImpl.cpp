    ...
    , mStartedOn(clock.system_now())
{
    ...
    TracyAppInfo(HCNET_CORE_VERSION.c_str(), HCNET_CORE_VERSION.size());
                             ...
                             std::optional<TimePoint> const& manualCloseTime)
{
    ...
    throw std::invalid_argument(
        "Set MANUAL_CLOSE=true in the hcnet-core.cfg if you want to "
        "close every ledger manually. Otherwise, run hcnet-core "
